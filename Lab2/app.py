...
def edit_Schedule():
    ...
    if request.method == 'GET':
        ...
        return render_template('EditSchedule.html', form=form, form_name="Edit Schedule", action="editSchedule?date=" + schedule.date)
    else:
...
def edit_Queue():
    ...
    if request.method == 'GET':
        ...
        return render_template('EditQueue.html', form=form, form_name="Edit Queue", action="editQueue?queue_name=" + queue.queue_name)
    else:
